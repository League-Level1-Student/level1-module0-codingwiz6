...
int score=0;
		...
		String guess = JOptionPane.showInputDialog("Who is this? First name only please");
...
String guess2 = JOptionPane.showInputDialog("Who is this? First name only please");
if(guess2.equalsIgnoreCase("leonardo")) {
	JOptionPane.showMessageDialog(null, "Correct!");
	score++;
}
else {
	JOptionPane.showMessageDialog(null, "Incorrect. That is Leonardo.");
}
 
showNextImage();

String guess3 = JOptionPane.showInputDialog("Who is this? First name only please");
if(guess3.equalsIgnoreCase("morgan")) {
	JOptionPane.showMessageDialog(null, "Correct!");
	score++;
}
else {
	JOptionPane.showMessageDialog(null, "Incorrect. That is Morgan.");
}


showNextImage();

String guess4 = JOptionPane.showInputDialog("Who is this? First name only please");
if(guess4.equalsIgnoreCase("jack")) {
	JOptionPane.showMessageDialog(null, "Correct!");
	score++;
}
else {
	JOptionPane.showMessageDialog(null, "Incorrect. That is Jack.");
}
